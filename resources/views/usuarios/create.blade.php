...
@section('title', 'Nuevo Usuario - Licoreras')

@section('content')
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Nuevo Usuario</h1>
        <a href="{{ route('usuarios.index') }}" class="btn btn-secondary btn-rounded">
                ...
                <div class="card-body">
                    <form action="{{ route('usuarios.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('role') is-invalid @enderror" 
                                    ...
                                    <option value="almacen" {{ old('role') == 'almacen' ? 'selected' : '' }}>Almacén</option>
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Cajero:</strong> Solo punto de venta y ventas<br>
                            <strong>Almacén:</strong> Gestión de inventario y productos
                        </div>
